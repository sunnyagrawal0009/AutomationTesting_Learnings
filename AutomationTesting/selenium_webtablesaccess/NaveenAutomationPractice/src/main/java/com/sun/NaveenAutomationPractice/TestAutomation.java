...
public class TestAutomation {
	...
	public static void extracttextfromaTable() {
		...
		List<WebElement> elements = driver.findElements(By.cssSelector(".rt-tbody .rt-tr-group"));
		
		for(WebElement c:elements) {
			
			List<WebElement> cells = c.findElements(By.className("rt-td"));
